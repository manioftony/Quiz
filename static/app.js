mani = angular.module('quiz.service', []);
angular.module('quiz.directive', []);
angular.module('quiz.filter', []);


// var phonecatApp = angular.module('quiz', []);

mani.config(function($interpolateProvider){
...
$http.get('/question-answer/').success(function(data) {
  // debugger;
